...
@pytest.fixture
def products():
    return [{'name': '', 'price': 10, 'category': 'q', 'quantity': 1},
...
def orders():
    return [
        {'id': '1', 'date': '2019-04-03T18:35:29.512364',
            'items': [{'name': '', 'price': 1, 'quantity': 2},
                      {'name': '', 'price': 3, 'quantity': 3},
                      {'name': '', 'price': 4, 'quantity': 5}
                      ]},
        {'id': '2', 'date': '2019-05-03T18:35:29.512364',
            'items': [{'name': '', 'price': 2, 'quantity': 3}
                      ]},
        {'id': '3', 'date': '2019-05-06T18:35:29.512364',
            'items': [{'name': '', 'price': 3, 'quantity': 3}
                      ]},
        {'id': '4', 'date': '2019-07-10T18:35:29.512364',
            'items': [{'name': '', 'price': 3, 'quantity': 2}
                      ]},
        {'id': '5', 'date': '2019-07-12T18:35:29.512364',
...
def test_get_months_statistic(orders):
    assert get_months_statistic(orders) == {'2019.04': {'average_order_value': 20.0, 'order_count': 1},
